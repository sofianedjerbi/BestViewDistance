...
public class Variable{
    ...
    public static boolean hidereductionindice = BestViewDistance.plugin.getConfig().getBoolean("Other.HideReductionIndiceFromVdist");
    ...
    public static Double reductionIndice = 0.0; // The Reduction indice
